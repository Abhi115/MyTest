...
public class OfferCodeForCorporate extends DriverTestCase{
    ...
    @Test
    public void test_006OfferCodeForCorporate() throws Exception {
        ...
        try {
            ...
            String corporateType = propertyReader.readTestData("CorporateType");
            addLog("Select Corporate Type " +corporateType+" from corporate Type dropdown");
            adminAddOfferPage=adminAddOfferPage.selectCorporate(corporateType);
            ...
            captureScreenshot("test_006OfferCodeForCorporate");
            throw e;
