...
public class OrderSummaryPage extends DriverHelper {
	 ...
	 * @throws Exception
	 */
	public OrderSummaryPage dataVerificationInUserTable(String custID) throws Exception {
		OrderSummaryPage orderSummary;
		orderSummary = (OrderSummaryPage)databaseVerification.dataVerificationInUserTable(OrderSummaryPage.class,custID);
		return orderSummary;
	}
	 ...
	 * @throws Exception
	 */
	public OrderSummaryPage dataVerificationForReferredUserInUserTable(String custID) throws Exception {
		OrderSummaryPage orderSummary;
		orderSummary = (OrderSummaryPage)databaseVerification.dataVerificationForReferredUserInUserTable(OrderSummaryPage.class,custID);
		return orderSummary;
	}
	 ...
	 * @throws Exception
	 */
	public OrderSummaryPage dataVerificationInUser_LeadsTable(String courseId, String webSiteAction, String country,String campaignSource, String campaignName, String campaignMedium) throws Exception {
		OrderSummaryPage orderSummary;
		orderSummary = (OrderSummaryPage)databaseVerification.dataVerificationInUserLeadTable(OrderSummaryPage.class, courseId, webSiteAction, country, campaignSource, campaignName,campaignMedium);
		return orderSummary;
	}
	 ...
	 * @throws Exception
	 */
	public OrderSummaryPage dataVerificationInUser_EventTable(String courseId, String event_context,String utm_campaign,String event_Type) throws Exception {
		OrderSummaryPage orderSummary;
		orderSummary = (OrderSummaryPage)databaseVerification.dataVerificationInUser_Events_Table(OrderSummaryPage.class, courseId, event_context, utm_campaign, event_Type);
		return orderSummary;
	}
	 ...
	 * @throws Exception
	 */
	public  OrderSummaryPage dataVerificationInCompleted_Queue_Jobs_Table(String courseStatus, String courseProperty, String event_Type) throws Exception {
		OrderSummaryPage orderSummaryPage;
		orderSummaryPage = ( OrderSummaryPage)databaseVerification.dataVerificationInCompleted_Queue_Jobs_Table(OrderSummaryPage.class,courseStatus, courseProperty, event_Type);
	 ...
	 * @throws Exception
	 */
	public OrderSummaryPage dataVerificationInUser_PreOrderTable(String course_Id, String courseTitle,String gateway,String currency,String testCaseName,String excelSheetName) throws Exception {
		OrderSummaryPage orderSummary;
		orderSummary = (OrderSummaryPage)databaseVerification.dataVerificationInPreOrderTable(OrderSummaryPage.class, course_Id, courseTitle,gateway,currency,testCaseName,excelSheetName);
		return orderSummary;
	}
	...
	public OrderSummaryPage selectB1S2Course(String b1S2CourseName) throws Exception {
	   ...
	   * @throws Exception
	   */
	  public OrderSummaryPage dataVerificationInUser_PreOrderTableForLeadProcess(String course_Id, String courseTitle) throws Exception {
		  OrderSummaryPage orderSummaryPage;
		  orderSummaryPage = (OrderSummaryPage)databaseVerification.dataVerificationInPreOrderTableForLeadProcess(OrderSummaryPage.class, course_Id, courseTitle);
	      return orderSummaryPage;
	  }
