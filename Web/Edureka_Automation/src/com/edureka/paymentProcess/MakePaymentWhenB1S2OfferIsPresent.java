...
public class MakePaymentWhenB1S2OfferIsPresent extends DriverTestCase{
	...
	@Test(dependsOnMethods={"test_016MakePaymentWhenB1S2OfferIsPresent"})
	public void test_021BackendDatabaseValidationWhenB1S2Offer() throws Exception {
		try {  
			...
			captureScreenshot("test_020BackendDatabaseValidationWhenB1S2Offer");
			throw e;
		} catch (final Exception e) {
			captureScreenshot("test_020BackendDatabaseValidationWhenB1S2Offer");
			throw e;
