...
public class MakePaymentWhenAnyTypeOfDiscountNotB1S2 extends DriverTestCase{
	...
	@Test
	public void test_014MakePaymentWhenAnyTypeOfDiscountNotB1S2() throws Exception {
		...
		try {
			...
			orderSummaryPage=orderSummaryPage.dataVerificationInUser_PreOrderTable(course_Id, course_Title, "",currency,"MakePaymentWhenAnyTypeOfDiscountNotB1S2","pre_orders");
			...
			myProfilePage=myProfilePage.dataVerificationInUser_PreOrderTable(course_Id,course_Title,paymentGateway,currency,"MakePaymentWhenAnyTypeOfDiscountNotB1S2","pre_orders_RazorPayment");
			...
			addLog("Verify Data in Pre-Order table");
			myProfilePage=myProfilePage.dataVerificationInUser_PreOrderTable(course_Id,course_Title,paymentGateway,currency,"MakePaymentWhenAnyTypeOfDiscountNotB1S2","pre_orders_PapalPayment");
