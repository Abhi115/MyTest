...
public class VerifyCourseAmountOnOrderSummaryForINR extends DriverTestCase{
    ...
    @Test
    public void test_06VerifyCourseAmountOnOrderSummaryForINR() throws Exception {
        ...
        try {
            ...
            captureScreenshot("test_06VerifyCourseAmountOnOrderSummaryForINR");
            throw e;
