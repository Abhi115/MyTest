...
public class VerifyCourseSpecificDiscount extends DriverTestCase{
    ...
    @Test
    public void test_02VerifyCourseSpecificDiscount() throws Exception {
        ...
        try {
            ...
            captureScreenshot("test_02VerifyCourseSpecificDiscount");
            throw e;
