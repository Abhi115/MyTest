...
public class VerifyValueOfEnrolmentsNumberInsideReferral extends DriverTestCase{
        ...
        try {
         ...
         // Verify Edureka Dashboard Page
           ...
           // Verify LogIn Is Default
            ...
            addLog("Enter email "+referralEmail_3);
            myProfilePage=myProfilePage.referFriend(referralEmail_3);
