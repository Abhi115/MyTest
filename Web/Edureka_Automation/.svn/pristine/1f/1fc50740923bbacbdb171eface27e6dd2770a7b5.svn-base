...
public class UserHomePage extends DriverHelper {
     ...
     * @throws Exception
     */
    public UserHomePage dataVerificationInUserTable(String custID) throws Exception {
        UserHomePage userHomePage;
        userHomePage = (UserHomePage)databaseVerification.dataVerificationInUserTable(UserHomePage.class,custID);
        return userHomePage;
    }
    /**
     *  Verify Data in user Table
