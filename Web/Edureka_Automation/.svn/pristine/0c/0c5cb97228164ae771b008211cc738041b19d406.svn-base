...
public class AdminAddOfferPage extends DriverHelper{
     ...
     * @return
     */
    public AdminAddOfferPage checkCouponCode() {
        String chkCouponCode=adminAddOffer.getLocator("Discount.CHKCouponCode");
        WaitForElementPresent(chkCouponCode, getTimeOut());
        clickOn(chkCouponCode);
        return PageFactory.initElements(driver, AdminAddOfferPage.class);
    }
