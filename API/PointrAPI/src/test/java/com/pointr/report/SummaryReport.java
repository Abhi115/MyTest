...
public class SummaryReport implements IReporter {
	...
	protected void writeSuiteSummary() {
		...
		/*
		 * if (testIndex >= 1) { writer.print("<tr>");
		 * writer.print("<th>Total</th>");
		 ...
		 * writeTableHeader(
		 * decimalFormat.format(millisecondsToSeconds(totalDuration)), "num");
		 * //writer.print("<th colspan=\"2\"></th>"); writer.print("</tr>"); }
		 */
